...
export default function CouponManagement() {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/api/discount`,
        {
          ...
          body: JSON.stringify({
            ...
            maxClaims: Number.parseInt(formData.maxClaims),
            active: true,
          }),
        }
      );
  ...
  const handleDelete = async (couponId: string) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/api/discount/${couponId}`,
        {
          method: "DELETE",
        }
      );
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Create and manage discount coupons for your internship courses
          </p>
        </div>
                  ...
                  {coupons.map((coupon:any) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() =>
                            toggleActive(coupon._id, coupon.active)
                          }
